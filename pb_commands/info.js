...
const cmd = {
    ...
    exec: function (opts = {}) {
        ...
        embed.addField("Disclaimer :warning:", "Please be aware that this bot logs guild activity (for development purposes only). If you want a copy of this guild's log-file, you can request it using the getlog command. (Mod Only)");
        embed.setTimestamp();
